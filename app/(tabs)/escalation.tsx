...
const styles = StyleSheet.create({
  ...
  title: { color: '#F5E6D3', fontSize: 22, fontWeight: '700' },
  subtitle: { color: '#D8A46B', fontSize: 12, marginTop: 2 },
  badge: {
    backgroundColor: '#E66A6A', borderRadius: 14,
    paddingHorizontal: 10, paddingVertical: 4,
  },
  badgeText: { color: '#F5E6D3', fontSize: 13, fontWeight: '700' },
  list: { padding: 16, gap: 10 },
  alertCard: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    backgroundColor: '#6D3B4B', borderRadius: 14,
    padding: 14, borderWidth: 0.5, borderColor: '#8B6F74',
  },
  alertUnseen: {
  ...
  alertMsg: { color: '#F2EDE8', fontSize: 13, lineHeight: 18 },
  alertMeta: { flexDirection: 'row', gap: 8 },
  alertSource: {
    color: '#F2EDE8', fontSize: 11,
    textTransform: 'uppercase', letterSpacing: 0.5,
  },
  alertTime: { color: '#F2EDE8', fontSize: 11 },
  unseenDot: {
    width: 8, height: 8, borderRadius: 4, backgroundColor: '#E66A6A',
  },
  emptyWrapper: { alignItems: 'center', marginTop: 60, gap: 8 },
  emptyIcon: { fontSize: 48 },
  emptyText: { color: '#F2EDE8', fontSize: 16, fontWeight: '600' },
  emptySub: { color: '#F2EDE8', fontSize: 13 },
});
