...
const styles = StyleSheet.create({
  ...
  title: { color: '#F5E6D3', fontSize: 26, fontWeight: '700', letterSpacing: 0.3 },
  subtitle: { color: '#D8A46B', fontSize: 13, marginTop: 4 },
  card: {
  ...
  idleTitle: { color: '#F5E6D3', fontSize: 17, fontWeight: '600', marginBottom: 8, textAlign: 'center' },
  idleSub: { color: '#D8A46B', fontSize: 13, textAlign: 'center', lineHeight: 19, marginBottom: 24 },
  ...
  chip: {
    ...
    backgroundColor: 'rgba(255,255,255,0.06)', borderWidth: 0.5, borderColor: '#8B6F74',
  },
  chipSelected: { backgroundColor: 'rgba(255,77,121,0.18)', borderColor: '#E66A6A' },
  chipText: { color: '#F2EDE8', fontSize: 14, fontWeight: '500' },
  chipTextSelected: { color: '#E66A6A', fontWeight: '700' },
  timerActiveLabel: { color: '#D8A46B', fontSize: 11, letterSpacing: 2, marginBottom: 12 },
  countdown: { color: '#E66A6A', fontSize: 72, fontWeight: '700', letterSpacing: 2 },
  timerHint: { color: '#F2EDE8', fontSize: 12, marginTop: 8, marginBottom: 24, textAlign: 'center' },
  progressTrack: { width: '100%', height: 6, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 3, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: '#E66A6A', borderRadius: 3 },
  progressLabels: { flexDirection: 'row', justifyContent: 'space-between', width: '100%', marginTop: 6 },
  progressLabelText: { color: '#F2EDE8', fontSize: 11 },
  expiredCard: {
  ...
  expiredSub: { color: '#F2EDE8', fontSize: 13, textAlign: 'center', marginBottom: 24 },
  resetBtn: {
  ...
  startBtn: {
    backgroundColor: '#E66A6A', borderRadius: 16, paddingVertical: 18, alignItems: 'center',
    shadowColor: '#E66A6A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 8,
  },
  startBtnText: { color: '#F5E6D3', fontSize: 16, fontWeight: '700', letterSpacing: 0.3 },
  safeBtn: {
    backgroundColor: '#F28C82', borderRadius: 16, paddingVertical: 20,
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10,
    shadowColor: '#F28C82', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 8,
  },
  safeBtnIcon: { fontSize: 22 },
  safeBtnText: { color: '#F5E6D3', fontSize: 18, fontWeight: '700', letterSpacing: 0.3 },
  cancelBtn: {
    backgroundColor: '#6D3B4B', borderWidth: 0.5, borderColor: '#8B6F74',
    borderRadius: 14, paddingVertical: 14, alignItems: 'center',
  },
  cancelBtnText: { color: '#F2EDE8', fontSize: 14, fontWeight: '500' },
  infoCard: {
    backgroundColor: 'rgba(255,77,121,0.06)', borderWidth: 0.5, borderColor: '#8B6F74',
    borderRadius: 14, padding: 14, alignItems: 'center',
  },
  infoText: { color: '#D8A46B', fontSize: 12, textAlign: 'center', lineHeight: 18 },
});
