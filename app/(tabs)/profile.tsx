...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#F5E6D3', fontSize: 28, fontWeight: '700', letterSpacing: 0.5 },
  card: {
  ...
  avatarCircle: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#E66A6A', alignItems: 'center', justifyContent: 'center' },
  avatarLetter: { color: '#F5E6D3', fontSize: 26, fontWeight: '700' },
  userInfo: { flex: 1, marginLeft: 16, justifyContent: 'center', gap: 4 },
  displayName: { color: '#F5E6D3', fontSize: 17, fontWeight: '600' },
  emailText: { color: '#D8A46B', fontSize: 13 },
  verifiedBadge: {
  ...
  verifiedText: { color: '#F28C82', fontSize: 11, fontWeight: '500' },
  sectionTitle: {
    color: '#D8A46B', fontSize: 11, fontWeight: '600',
  ...
  settingLabel: { flex: 1, color: '#F5E6D3', fontSize: 15 },
  chevron: { color: '#F2EDE8', fontSize: 22, fontWeight: '300', lineHeight: 24 },
  ...
  logoutBtn: {
    ...
    borderWidth: 0.5, borderColor: '#8B6F74', borderRadius: 16, minHeight: 52,
  },
  logoutText: { color: '#E66A6A', fontSize: 15, fontWeight: '600', letterSpacing: 0.3 },
  versionText: { color: '#F2EDE8', fontSize: 12, textAlign: 'center', marginTop: 24 },
});
